...
var URL_DEFAULT = "http://gentle-crag-7590.herokuapp.com/";
...
var callThis = function(result) {
    if (data instanceof Error) {
      ...
      this.retry(4000); // Try again after 4 seconds
    }
    else {
      sys.puts(result);
    }
...
if(require.main == module) {
	...
	.option('-u, --url <url_link>', 'URL or file', clone(assertUrlExists), URL_DEFAULT)
        .parse(process.argv);
